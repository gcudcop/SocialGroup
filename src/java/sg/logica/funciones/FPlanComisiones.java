...
public class FPlanComisiones {
     ...
     public static List<PlanComisiones> obtenerPlanComisiones() throws Exception {
        ...
        try {
            ...
            sql = "SELECT * FROM sch_social_group.f_obtener_plan_comisiones();";
            resultSet = accesoDatos.ejecutaQuery(sql);
            while (resultSet.next()) {
                planCom = new PlanComisiones();
                planCom.setIdPlanComsion(resultSet.getInt("sr_id_plan_comsion"));
                planCom.getPif().setIdPif(resultSet.getInt("sr_id_pif"));
...
public static String insertarPlanComisiones(PlanComisiones planCom) throws Exception {
        String respuesta="";
        AccesoDatos accesoDatos;
        String sql;
